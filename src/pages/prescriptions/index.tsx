          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                Create & print digital Rx. Add, edit, search, filter and export
                records from here.
              </p>
            </div>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <Card className="min-w-0">
          <CardContent className="p-4">
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                <p className="text-2xl font-bold tracking-tight">248</p>
        ...
        <Card className="min-w-0">
          <CardContent className="p-4">
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                <p className="text-2xl font-bold tracking-tight">214</p>
        ...
        <CardContent className="p-0">
          <div className="w-full overflow-x-auto">
            <div className="min-w-[900px]">
              {/* Table Header */}
              <div className="grid grid-cols-[1.1fr_1.3fr_1.3fr_1.8fr_0.9fr_1fr_1.2fr] items-center border-b bg-slate-50 px-4 py-3 text-[10px] font-semibold tracking-wider text-slate-500 uppercase">
                <div>Reference</div>
                <div>Patient</div>
                <div>Diagnosis</div>
                <div>Medicines</div>
              ...
              <div className="divide-y divide-slate-100">
                {prescriptions.map((prescription) => (
                  <div
                    ...
                    className="grid grid-cols-[1.1fr_1.3fr_1.3fr_1.8fr_0.9fr_1fr_1.2fr] items-center px-4 py-4 transition-colors hover:bg-slate-50"
                  >
          ...
          <div className="border-t bg-slate-50 px-4 py-2 text-center text-[11px] text-muted-foreground sm:hidden">
            Swipe horizontally to view all prescription details.
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="pt-0">
          <div className="w-full overflow-hidden">
            ...
            >
              ...
              {/* Area */}
              <path d={areaPath} fill="url(#prescription-area)" />

              {/* Line */}
              <path
                d={linePath}
                fill="none"
                stroke="url(#prescription-line)"
                strokeWidth="3"
                strokeLinecap="round"
