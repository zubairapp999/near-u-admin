          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                Consultation revenue. Add, edit, search, filter and export
                records from here.
              </p>
            </div>
        ...
        <CardContent className="p-0">
          <div className="w-full overflow-x-auto">
            <div className="min-w-[850px]">
              {/* Table Header */}
              <div className="grid grid-cols-[1.1fr_1.5fr_1fr_1.2fr_1fr_1fr_1.2fr] items-center border-b bg-slate-50 px-4 py-3 text-[10px] font-semibold tracking-wider text-slate-500 uppercase">
                <div>Reference</div>
                <div>Record</div>
                <div>Gross</div>
              ...
              <div className="divide-y divide-slate-100">
                {earnings.map((earning) => (
                  <div
                    key={earning.reference}
                    className="grid grid-cols-[1.1fr_1.5fr_1fr_1.2fr_1fr_1fr_1.2fr] items-center px-4 py-4 transition-colors hover:bg-slate-50"
                  >
          ...
          <div className="border-t bg-slate-50 px-4 py-2 text-center text-[11px] text-muted-foreground sm:hidden">
            Swipe horizontally to view all earning details.
          </div>
        </CardContent>
      </Card>
