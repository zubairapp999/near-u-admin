...
const publicProfileRecords = [
  {
    reference: "#PP-1001",
    field: "Profile Status",
    value: "Published",
    details: "Visible to patients",
    updated: "14 Sep 2026",
    status: "Active",
  },
  {
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                Clinic profile & verification. Add, edit, search, filter and
        ...
        <CardContent className="p-0">
          <div className="w-full overflow-x-auto">
            <div className="min-w-[900px]">
              {/* Table Header */}
              <div className="grid grid-cols-[1.1fr_1.2fr_1.2fr_1.6fr_1.3fr_1fr_1.2fr] items-center border-b bg-slate-50 px-4 py-3 text-[10px] font-semibold tracking-wider text-slate-500 uppercase">
                <div>Reference</div>
                <div>Field</div>
                <div>Value</div>
                <div>Details</div>
              ...
              <div className="divide-y divide-slate-100">
                {publicProfileRecords.map((record) => (
                  <div
                    key={record.reference}
                    className="grid grid-cols-[1.1fr_1.2fr_1.2fr_1.6fr_1.3fr_1fr_1.2fr] items-center px-4 py-4 transition-colors hover:bg-slate-50"
                  >
          ...
          <div className="border-t bg-slate-50 px-4 py-2 text-center text-[11px] text-muted-foreground sm:hidden">
            Swipe horizontally to view all profile details.
          </div>
        </CardContent>
      </Card>
          ...
          <div className="w-full overflow-hidden">
            ...
            >
              <defs>
                ...
                <linearGradient id="profile-line" x1="0" y1="0" x2="1" y2="0">
