          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                Bank settlements. Add, edit, search, filter and export records
                from here.
              </p>
            </div>
        ...
        <CardContent className="p-0">
          <div className="w-full overflow-x-auto">
            <div className="min-w-[850px]">
              {/* Table Header */}
              <div className="grid grid-cols-[1.1fr_1.5fr_1.5fr_1.2fr_1.3fr_1fr_1.2fr] items-center border-b bg-slate-50 px-4 py-3 text-[10px] font-semibold tracking-wider text-slate-500 uppercase">
                <div>Reference</div>
                <div>Payout</div>
                <div>Period</div>
                <div>Amount</div>
              ...
              <div className="divide-y divide-slate-100">
                {payouts.map((payout) => (
                  <div
                    ...
                    className="grid grid-cols-[1.1fr_1.5fr_1.5fr_1.2fr_1.3fr_1fr_1.2fr] items-center px-4 py-4 transition-colors hover:bg-slate-50"
                  >
                    ...
                    <div className="text-sm text-slate-600">{payout.bank}</div>
          ...
          <div className="border-t bg-slate-50 px-4 py-2 text-center text-[11px] text-muted-foreground sm:hidden">
            Swipe horizontally to view all payout details.
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="min-w-0 overflow-hidden">
        ...
        <CardContent className="pt-0">
          <div className="w-full overflow-hidden">
            ...
            >
              <defs>
                <linearGradient id="payout-area" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#8b7cf6" stopOpacity="0.25" />

                  <stop offset="100%" stopColor="#8b7cf6" stopOpacity="0.03" />
                </linearGradient>

                <linearGradient id="payout-line" x1="0" y1="0" x2="1" y2="0">
              ...
              {/* Area */}
              <path d={areaPath} fill="url(#payout-area)" />

              {/* Line */}
              <path
                d={linePath}
                fill="none"
                stroke="url(#payout-line)"
                strokeWidth="3"
                strokeLinecap="round"
